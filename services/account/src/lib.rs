...
const RECOVERY_SESSION_TTL_SECONDS: u64 = 15 * 60;
...
impl AccountState {
    ...
    fn connection(&self) -> Result<std::sync::MutexGuard<'_, Connection>, AccountServiceError> {
        self.db
            .lock()
