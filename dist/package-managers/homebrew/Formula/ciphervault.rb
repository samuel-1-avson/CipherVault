class Ciphervault < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/samuel-1-avson/CipherVault/releases/download/v1.0.8/ciphervault-v1.0.7-aarch64-apple-darwin.tar.gz"
    else
      url "https://github.com/samuel-1-avson/CipherVault/releases/download/v1.0.8/ciphervault-v1.0.7-x86_64-apple-darwin.tar.gz"
    end
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/samuel-1-avson/CipherVault/releases/download/v1.0.8/ciphervault-v1.0.7-aarch64-unknown-linux-gnu.tar.gz"
    else
      url "https://github.com/samuel-1-avson/CipherVault/releases/download/v1.0.8/ciphervault-v1.0.7-x86_64-unknown-linux-gnu.tar.gz"
    end
  end
